  ...
  <div class="rounded-lg bg-white p-6 shadow-md">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
      <button
        ...
        class="rounded-lg border border-gray-300 bg-gray-100 px-4 py-4 text-center font-semibold transition duration-150 hover:cursor-pointer hover:bg-blue-100"
      >
        Anglais → Français
      </button>
      <button
